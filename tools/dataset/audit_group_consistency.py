...
def main() -> int:
    ...
    fields = ["group_id", "group_size", "image_path", "annotation_signature", "group_signature_count", "group_has_annotation_mismatch", "group_has_missing_json"]
    ...
    summary = {"group_count": len(groups), "annotation_mismatch_group_count": len(mismatch_groups), "groups_with_missing_json_count": len(missing_groups), "mismatch_groups": sorted(mismatch_groups), "groups_with_missing_json": sorted(missing_groups)}
