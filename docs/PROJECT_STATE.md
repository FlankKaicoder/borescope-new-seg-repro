...
| Field | Current fact |
|---|---|
| Current phase | Exp02.0--Exp02.2 complete; stopped at Baseline Gate for user review |
...
| Next allowed experiment | NONE until user reviews Baseline Gate STOP; Exp02.3 remains prohibited |
| Formal training allowed | NO; Exp02.1 is complete and no further training is authorized |
