...
| Field | Current fact |
|---|---|
| Current phase | `EXP10_DIAGNOSTIC_COMPLETE_WAITING_REVIEW` |
...
| Current Gate | Exp10.1a classified seed43 Treatment failure as `CASE C FP32_MODEL_OR_OPTIMIZATION_INSTABILITY`; Exp10 remains stopped/incomplete |
| Active blockers | Exact saved batch/state is non-finite in both AMP and FP32 forward before optimizer step1; three-seed comparison is incomplete. |
...
| Next allowed experiment | None automatically; review Exp10.1a CASE C evidence |
...
| Last updated time | 2026-08-14T14:30:00+08:00 |

## Next allowed work

Review `docs/handoffs/EXP10_1A_NAN_ROOT_CAUSE_REVIEW.md`. Do not resume Exp10, start Exp11, freeze a candidate, or access VAL/TEST automatically.
